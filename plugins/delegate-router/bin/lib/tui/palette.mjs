...
export function createPalette(env = process.env) {
  ...
  return Object.freeze({
    ...
    planCompleted: colored(colorsEnabled, { fg: values.statusRunning, dim: true }),
    planActive: colored(colorsEnabled, { fg: values.accentFg }),
    planPending: colorsEnabled ? Object.freeze({ fg: values.dimFg, dim: true }) : Object.freeze({ dim: true }),
